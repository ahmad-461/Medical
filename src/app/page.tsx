    ...
    <div className="flex flex-col">
      ...
      <section className="bg-white dark:bg-gray-950 py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
            Millions of patients every year struggle to understand their prescriptions. Studies show that medication errors caused by misunderstood prescriptions are one of the leading causes of preventable harm in healthcare. Common confusion points include dose frequencies like OD (once daily), BD (twice daily), and TDS (three times daily), as well as timing instructions like AC (before meals), PC (after meals), and HS (at bedtime). RxReader automatically decodes all of these abbreviations and explains them in plain English so you always know exactly when and how to take your medicines.
          </p>
